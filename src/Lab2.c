...
void BackgroundThread1d(void){   // called at 1000 Hz
  Count1++;
  OS_Signal(&Readyd);		//sets up possible race condition
}
void Thread5d(void){		//simulation of race condition racer 1
  for(;;){
    OS_Wait(&Readyd);
...
void Thread2d(void){	//simulation of race condition racer 2
